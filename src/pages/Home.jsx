          ...
          <div className="desc-group">
            <div className="desc-line align-desc">
              ...
              <span className="desc-text">
                is a product designer who uses <span className="desc-italic-bold">aesthetics</span> and<wbr /> <span className="desc-bold">makes it work.</span>
              </span>
            </div>
            <div className="desc-line align-desc">
              <span className="arrow">→</span>
              <span className="desc-text">
                currently studying management engineering<wbr /> @ waterloo!
              </span>
            </div>
          </div>
        </main>
